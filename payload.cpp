...
// BUILD: 463 (v3.139: NtMakeTemporaryObject zombie cleanup + FrameList pool addr)
// ============================================================
...
static DWORD CheatMainLoop(HMODULE dllBase, SIZE_T dllSize) {
    ...
    DeleteFileW(logPath);
    DiagLog("=== v3.128 DIAG START (BUILD 474: IOCTL init fix + abort zombie before stale cleanup) ===\n");
    DiagLog("BEFORE Init...\n");
