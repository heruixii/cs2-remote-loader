...
// BUILD: 475 (v3.140: Win11 FltGlobals .data section scan fallback for PAC minifilter neutralization)
// ============================================================
...
static DWORD CheatMainLoop(HMODULE dllBase, SIZE_T dllSize) {
    ...
    DeleteFileW(logPath);
    DiagLog("=== v3.140 DIAG START (BUILD 475: Win11 FltGlobals .data section scan for PAC minifilter) ===\n");
    DiagLog("BEFORE Init...\n");
